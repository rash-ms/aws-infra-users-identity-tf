locals {
  ...
  # Ensure mappings include group name, policy name, and email
  group_mappings = {
  ...
  # Select policies based on environment (dev/prod)
...
# ✅ Ensure AWS Organization exists before creating OUs
