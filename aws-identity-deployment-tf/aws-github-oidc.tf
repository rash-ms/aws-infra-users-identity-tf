...
# Define the provider for AWS (global provider block, no for_each)
provider "aws" {
  region = "us-east-1" # Default region; can be overridden in modules
}

# Call the module for each account
